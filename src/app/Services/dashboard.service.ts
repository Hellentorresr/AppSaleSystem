...
export class DashboardService {
  private urlApi: string = `${environment.endPoint}Dashboard/`;  //the user endpoint
  ...
  List(): Observable<ResponseApi> {
    ...
    return this.http.get<ResponseApi>(`${this.urlApi}Summary`, { 'headers': this.headers }); //the final endpoint
  }
}
